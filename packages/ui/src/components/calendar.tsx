...
import { Button, buttonVariants } from "@website/ui/components/button";
...
const CalendarDayButtonWithLocale: NonNullable<
  DayPickerComponents["DayButton"]
> = (props) => {
...
const DEFAULT_CALENDAR_COMPONENTS: DayPickerComponents = {
  Root: CalendarRoot,
