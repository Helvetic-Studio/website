...
const InputGroupAddon = function InputGroupAddon({
  className,
  align = "inline-start",
  ...props
...
const InputGroupButton = function InputGroupButton({
  className,
  type = "button",
  variant = "ghost",
  size = "xs",
...
const InputGroupInput = function InputGroupInput({
  className,
  ...props
...
const InputGroupTextarea = function InputGroupTextarea({
  className,
  ...props
