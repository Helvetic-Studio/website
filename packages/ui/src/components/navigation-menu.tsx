...
const NavigationMenuPositioner = function NavigationMenuPositioner({
  className,
  side = "bottom",
  sideOffset = 8,
  align = "start",
...
const NavigationMenuList = function NavigationMenuList({
  className,
  ...props
...
const NavigationMenuItem = function NavigationMenuItem({
  className,
  ...props
...
const NavigationMenuTrigger = function NavigationMenuTrigger({
  className,
  children,
  ...props
...
const NavigationMenuContent = function NavigationMenuContent({
  className,
  ...props
...
const NavigationMenuLink = function NavigationMenuLink({
  className,
  ...props
...
const NavigationMenuIndicator = function NavigationMenuIndicator({
  className,
  ...props
